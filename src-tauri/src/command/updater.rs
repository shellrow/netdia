...
#[tauri::command]
pub async fn check_update(app: AppHandle, #[cfg(all(desktop, not(windows)))] pending: State<'_, PendingUpdate>) -> Result<UpdateInfo, String> {
...
pub async fn install_update(
    #[cfg(all(desktop, not(windows)))] pending: State<'_, PendingUpdate>,
